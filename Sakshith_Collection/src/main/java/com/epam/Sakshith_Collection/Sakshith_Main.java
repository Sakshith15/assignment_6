package com.epam.Sakshith_Collection;
...
public class Sakshith_Main {
	public static void main(String args[])
	{
		SakshithCollection obj = new SakshithCollection();
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("Please enter an integer between 1-4");  //valid input
